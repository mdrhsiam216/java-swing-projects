...
public class Pay extends JFrame {
    ...
    private JLabel label1, label2, label3,label4, imgLabel;
    ...
    Pay() {
        ...
        // Logo and Images
        logo = new ImageIcon(getClass().getResource("/Assets/flat-woman-paying-by-pos-terminal-refund-cashback_88138-785-removebg-preview (1).png"));
        imgLabel = new JLabel(logo);
        imgLabel.setBounds(30, 50, logo.getIconWidth(), logo.getIconHeight());
        c.add(imgLabel);

        img1 = new ImageIcon(getClass().getResource("/Assets/VisaCard.png"));
        imgLabel = new JLabel(img1);
        imgLabel.setBounds(620, 90, img1.getIconWidth(), img1.getIconHeight());
        c.add(imgLabel);

        img2 = new ImageIcon(getClass().getResource("/Assets/MasterCard.png"));
