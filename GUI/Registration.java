...
public class Registration extends JFrame implements ActionListener {
    ...
    public Registration(LogIn lg){
        ...
        image = new ImageIcon("./Assets/wedding-planner-concept-illustration_114360-2640-removebg-preview.png");
    ...
    public void actionPerformed(ActionEvent e) {
        if(RegisterBtn == e.getSource()){
            boolean flag= FileIO.registerUser(name.getText(), String.valueOf(pass.getPassword()), "./File/users.txt");
