...
public class CreateDonorPage extends JFrame implements ActionListener{
    ...
    public CreateDonorPage(LoginPage loginPage, RegisterPage registerPage){
        ...
        registerBtn.setBounds(950,530,200,40);
    ...
    public void actionPerformed(ActionEvent e){
        if(registerBtn==e.getSource()){
            ...
            Donor d=new Donor(UsernameField.getText(), NameField.getText(), contactNumberField.getText(), 
                        emailField.getText(), areaNameField.getText(), zipCodeField.getText(), 
                        bloodGroupField.getText(), rhFactorField.getText(), pass);
            DonorFileIO.registerDonor(d);
